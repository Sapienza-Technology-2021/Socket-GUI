...
class RoverUi(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.accel_X = self.graphWidget.plot(self.x, self.accel_data[0], pen=mkPen(color=(255, 0, 0),  width=3))
        self.accel_Y = self.graphWidget.plot(self.x, self.accel_data[1], pen=mkPen(color=(0, 0, 255),  width=3))
